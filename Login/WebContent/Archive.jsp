...
<div id="tabs" style="width: 100%; height: 100%;">
    ...
    <div id="fragment-1" style="width: 100%; height: 100%; -moz-box-sizing: border-box; margin-top: -27px; padding-top: 27px;">
        <iframe src='Archive_msg.jsp' style="width: 100%; height: 100%;" frameborder="0"></iframe>
    </div>
    <div id="fragment-2" style="width: 100%; height: 100%; -moz-box-sizing: border-box; margin-top: -27px; padding-top: 27px;">
