...
<tr>
	<td style="width: 80px; height: 30px;">Subject:</td><td colspan="4"><textarea rows="1" cols="1" name="content" style="resize: none; width: 100%; height: 25px; font-size: 16px; vertical-align: middle;" onfocus="blur();" spellcheck='false'><%=(String) request.getParameter("subject")%></textarea></td>
</tr>
<tr>
